...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/root/autodl-tmp/large-model/src/checkpoints/PE4')
    parser.add_argument('--result_dir', type=str, default='/root/autodl-tmp/large-model/results/PE4', 
