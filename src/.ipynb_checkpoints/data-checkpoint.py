...
def train_sentencepiece(corpus_files, model_prefix='spm', vocab_size=8000, model_type='bpe', model_dir='/root/autodl-tmp/large-model/sentence'):
...
def build_corpus_files(dataset, src_lang='en', tgt_lang='de', out_dir='tokenizer_corpus', max_samples=None):
