...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/root/autodl-tmp/large-model/src/checkpoints/noPE')
    parser.add_argument('--result_dir', type=str, default='/root/autodl-tmp/large-model/results/noPE', 
    ...
    # 4. 模型与优化器
    model = TransformerModel(len(src_sp), len(tgt_sp), d_model=512, nhead=4,
