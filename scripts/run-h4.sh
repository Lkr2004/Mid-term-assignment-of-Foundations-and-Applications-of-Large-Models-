...
BATCH_SIZE=64
SEED=42
SAVE_DIR="/root/autodl-tmp/large-model/src/checkpoints/PE4"
RESULT_DIR="/root/autodl-tmp/large-model/results/PE4"
...
# ---- 启动训练 ----
python3 /root/autodl-tmp/large-model/src/train4.py \
  --epochs $EPOCHS \
